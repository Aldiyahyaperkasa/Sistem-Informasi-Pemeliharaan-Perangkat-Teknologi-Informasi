...
<body>
    ...
    <div id="app">
        ...
        <div id="main">
            <!-- chart di role manajer -->
            <div class="d-flex justify-content-center">
                <div class="card w-75">
                    <div class="card-body">
                        <h5 class="card-title">Monthly Maintenance Statistics</h5>
    ...
    <script>
        ...
        // Find the maximum value from data
        const maxDataValue = Math.max(...<?= json_encode($maintenanceCounts) ?>);

        // Set suggestedMax to be a multiple of 5
        const suggestedMax = Math.ceil(maxDataValue / 5) * 5;
        ...
        const monthlyMaintenanceChart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: 'Maintenance History Count',
